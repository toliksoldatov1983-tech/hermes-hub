...
Единая точка входа в память Hermes-Clean. Папка Hermes-Clean одновременно является рабочим проектом и Obsidian-хранилищем.
...
Старые [архив] [удалённый архив], «Гермес Клин» и другие архивы не являются рабочей памятью и не могут переопределять данные Hermes-Clean.
