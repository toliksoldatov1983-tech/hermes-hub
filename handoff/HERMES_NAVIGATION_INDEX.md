# Hermes Navigation Index

Р”Р°С‚Р°: 2026-06-20

## РЎС‚Р°С‚СѓСЃ

| РљРѕРјРїРѕРЅРµРЅС‚ | РЎС‚Р°С‚СѓСЃ |
|-----------|--------|
| Р‘РѕС‚ | active/running |
| Autostart | disabled |
| Feature flag | OFF |
...
- `HERMES_HUB_STATE.md` вЂ” РїРѕР»РЅС‹Р№ СЃС‚Р°С‚СѓСЃ
- `START_NEW_CHAT_PROMPT.md` вЂ” СЃС‚Р°СЂС‚ РЅРѕРІРѕРіРѕ С‡Р°С‚Р°
- `NEXT_TASKS.md` вЂ” СЃР»РµРґСѓСЋС‰РёРµ Р·Р°РґР°С‡Рё
- `ACTIVE_BATCH.md` вЂ” С‚РµРєСѓС‰РёР№ active batch
- `REPORT_TO_CHATGPT.md` вЂ” РѕС‚С‡С‘С‚С‹ РІ ChatGPT

## Routing

Micro в†’ Hermes/DeepSeek | Batch в†’ Codex | Decisions в†’ РїРѕР»СЊР·РѕРІР°С‚РµР»СЊ
