...
```text
«Гермес Клин» / Malyarka Clean / existing server Telegram bot
```
...
- [архив] [удалённый архив] has short/long Obsidian memory.
- Server bot has Obsidian hooks/hints.

Status:

```text
present but not fully reconciled with «Гермес Клин»
```
...
1. Reconcile [архив] [удалённый архив] with «Гермес Клин».
...
Inventory executed: read-only scan of `E:\«Гермес Клин»` and `E:\[архив] [удалённый архив]`.

### LIVE — Active state and runtime

**«Гермес Клин» (мозг):**
- `HERMES_STATE.md` — главный state-файл проекта
...
**[архив] [удалённый архив] (Desktop-оболочка):**
...
- `START_HERE_FOR_HERMES_MALYARKA.md` — мост к «Гермес Клин»
...
**«Гермес Клин» handoff (батч-пакеты):**
...
**[архив] [удалённый архив] agents/:**
- `[удалённый архив]/`, `hermes-local/`, `hermes-memorykeeper/`, `hermes-orchestrator/` — SYSTEM_PROMPT.md каждый
...
- `[удалённый архив]` — 100+ файлов: часть может быть устаревшей после батчей 2026-06-20. Нужен review на дубликаты и противоречия.
- `[удалённый архив]` — 8 бандлов adapter implementation. Статус выполнения неясен без чтения содержимого.
- `E:\[удалённый архив]\MALYARKA_CURRENT_STATUS.md` — помечен как исторический, но всё ещё в корне. Решить: перенести в архив или удалить.
- `E:\[удалённый архив]\future-integrations\` — все 5 папок пусты. Заглушки или забытый план?
- `E:\[удалённый архив]\github\`, `repos\` — пусты. GitHub workflow не активирован.
...
- `E:\[удалённый архив]\agents\hermes-orders-future\` — только README, без SYSTEM_PROMPT.

### Что выглядит устаревшим

1. **[удалённый архив]/MALYARKA_CURRENT_STATUS.md** (12 июн) — источник истины теперь «Гермес Клин».
2. **[удалённый архив]/logs/CODEX_AUDIT_2026-06-12.md** — аудит 9-дневной давности.
3. **[удалённый архив]/logs/MALYARKA_GIT_DIFF_REVIEW_2026-06-12.md** — git diff review той же давности.
4. **[удалённый архив]/docs/** — множество AGENT_* и CODEX_* файлов от 12-17 июня с пометкой «Codex not available», которые могли устареть.
5. **[удалённый архив]/handoff/CODEX_HANDOFF_PROMPT_READY.md** — помечен 18 июн, статус «Codex not available» — [уточнить].
6. **[удалённый архив]/handoff/FINAL_NO_ACCESS_WAITING_STATE.md** (ссылка из доков) — [уточнить] актуален ли.
...
**Единый источник правды — «Гермес Клин».** [архив] [удалённый архив] используется только как Desktop-оболочка.

| Файл | Роль |
|---|---|
| `HERMES_STATE.md` | Главный state-файл всего проекта |
| `PROJECT_MASTER_MAP_MALYARKA_HERMES.md` | Эта карта |
...
**[архив] [удалённый архив] (только Desktop OS):**
...
**Итого LIVE:** 22 файла «Гермес Клин» + 8 файлов [архив] [удалённый архив] = **30 файлов.**
...
**Итого LOCAL:** 10 компонентов «Гермес Клин» + 5 компонентов [архив] [удалённый архив] = **15 компонентов.**
...
| Файл/папка | Причина |
|---|---|
| `[удалённый архив]/_archive/` | Пустой архив (только README) |
| `[удалённый архив]/_quarantine/` | Карантин (пуст) |
| `[удалённый архив]/_reports/` | Старые отчёты (пуст) |
| `[удалённый архив]/_scratch/` | Черновики (пуст) |
| `[удалённый архив]/backups/` | Бэкапы hermes-desktop, openwebui |
| `[удалённый архив]/files/archive/` | Файловый архив |
| `[удалённый архив]/tmp/` | Скриншоты Hermes Desktop, PDF-извлечение |
| `[удалённый архив]/logs/CODEX_AUDIT_2026-06-12.md` | Аудит 9-дневной давности |
| `[удалённый архив]/logs/MALYARKA_GIT_DIFF_REVIEW_2026-06-12.md` | Git diff review 9-дневной давности |
...
**«Гермес Клин» docs/ (основной массив планов):**
...
**Дубликаты между [архив] [удалённый архив] и «Гермес Клин»:**

| [архив] [удалённый архив] | «Гермес Клин» | Статус |
|---|---|---|
| `AGENTS.md` | `AGENTS.md` | Разные файлы с одним именем. [уточнить] какой приоритетнее |
| `MALYARKA_CURRENT_STATUS.md` | `HERMES_STATE.md` | Фактический дубликат по смыслу. MALYARKA_CURRENT_STATUS — исторический |
| `MALYARKA_START_HERE_FOR_HERMES.md` | `START_HERE_FOR_HERMES.md` + `START_HERE_FOR_HERMES_MALYARKA.md` | Три входных точки — [уточнить] нужны ли все |

**Файлы с неясным статусом:**

| Файл | Почему |
|---|---|
| `[удалённый архив]/handoff/CODEX_HANDOFF_PROMPT_READY.md` | 18 июн, «Codex not available» — актуально? |
| `[удалённый архив]/handoff/START_NEXT_WORK_SESSION_PROMPT.md` | 18 июн — [уточнить] |
| `[удалённый архив]/handoff/START_NEXT_CHAT_PROMPT_SERVER_ADAPTER_CLOSED.md` | 19 июн — [уточнить] |
| `[удалённый архив]/handoff/REPORT_TO_CHATGPT_SERVER_ADAPTER_FINAL.md` | 19 июн — [уточнить] |
| `[удалённый архив]/docs/FINAL_NO_ACCESS_WAITING_STATE.md` | Упоминается в индексе — [уточнить] актуален ли |
| `[удалённый архив]/task_bundles/` (8 бандлов) | Статус выполнения неясен без чтения содержимого |

**Пустые структуры в [архив] [удалённый архив] (созданы, но не заполнены):**
...
|---|---|
| `[удалённый архив]/agents/hermes-orders-future/` | Только README, нет SYSTEM_PROMPT |
| `[удалённый архив]/agents/[удалённый архив]/` | Только SYSTEM_PROMPT, нет AGENT_SPEC |
| `[удалённый архив]/agents/hermes-local/` | Только SYSTEM_PROMPT |
| `[удалённый архив]/agents/hermes-memorykeeper/` | Только SYSTEM_PROMPT |
| `[удалённый архив]/agents/hermes-orchestrator/` | Только SYSTEM_PROMPT |
...
|---|---|---|
| `[удалённый архив]/MALYARKA_CURRENT_STATUS.md` | Источник правды теперь «Гермес Клин» | `HERMES_STATE.md` |
| `[удалённый архив]/MALYARKA_START_HERE_FOR_HERMES.md` | Заменён мостом к проекту | `START_HERE_FOR_HERMES_MALYARKA.md` |
| `[удалённый архив]/logs/CODEX_AUDIT_2026-06-12.md` | 9 дней, проект ушёл вперёд | `logs/WORKLOG.md` («Гермес Клин») |
| `[удалённый архив]/logs/MALYARKA_GIT_DIFF_REVIEW_2026-06-12.md` | 9 дней | — |
| `[удалённый архив]/docs/CODEX_PROMPTS_READY_INDEX.md` | «Codex not available» — устарело | — |
| `[удалённый архив]/docs/CODEX_START_HERE_WHEN_AVAILABLE.md` | «Codex not available» — устарело | `START_HERE_FOR_CODEX.md` |
| `[удалённый архив]/docs/CODEX_TASK_QUEUE_WHEN_AVAILABLE.md` | «Codex not available» — устарело | `sync/NEXT_BATCH_QUEUE.md` |
| `[удалённый архив]/handoff/CODEX_HANDOFF_PROMPT_READY.md` | 18 июн, «Codex not available» | — |
...
1. `[удалённый архив]/MALYARKA_CURRENT_STATUS.md` — исторический, противоречит «Гермес Клин».
2. `[удалённый архив]/MALYARKA_START_HERE_FOR_HERMES.md` — ведёт в старую структуру.
3. `[удалённый архив]/logs/CODEX_AUDIT_*` и `MALYARKA_GIT_DIFF_REVIEW_*` — устаревшие аудиты.
4. Все файлы с пометкой «Codex not available» в `docs/` и `handoff/`.
5. `[удалённый архив]/backups/` — бэкапы, не рабочие данные.
...
Три системы. Одна цель: «Гермес Клин» — мозг, Telegram — будущий интерфейс с телефона.
...
### 🏗️ Система B: «Гермес Клин» (LIVE · центральный мозг)
...
### 🏗️ Система C: [архив] [удалённый архив] / Hermes Desktop (LIVE · оболочка)
...
**Поток [архив] [удалённый архив]:**
```
Hermes Desktop → OS rules → Obsidian memory → prompts → pult/launcher → МОСТ → «Гермес Клин»
```
...
| 3 | `adapter_boundary_snapshot/` | «Гермес Клин» local | **Готово** — read-only копии для анализа |
| 4 | `adapter_boundary_fix_candidate/` | «Гермес Клин» local | **Готово** — order-like fallback fix |
| 5 | `hermes_adapter_fake/` | «Гермес Клин» local | **166 тестов passed** — contract tests |
| 6 | `projects/malyarka-clean/` | «Гермес Клин» local | **Scaffold** — будущий чистый core |
| 7 | `START_HERE_FOR_HERMES_MALYARKA.md` | [архив] [удалённый архив] | **LIVE** — мост General→Гермес Клин |
...
| 🧠 **Центральный мозг** | `E:\«Гермес Клин»` | 🟢 LIVE · источник правды |
| 💻 **Desktop-оболочка** | `E:\[архив] [удалённый архив]` | 🟢 LIVE · OS + Obsidian |
| 📦 **Локальный код** | `[удалённый архив]` | 🟡 LOCAL · scaffold |
| 🧪 **Тесты адаптера** | `[удалённый архив]` | 🟡 LOCAL · 166 passed |
| 📋 **Планы** | `[удалённый архив]` | 📋 PLANS · ~100+ файлов |
| 🗄️ **Архив** | `[удалённый архив]`, `[удалённый архив]\backups\` | ⬜ ARCHIVE |
...
| **Мозг** | Собственный (app/router/handlers) | «Гермес Клин» управляет, бот — интерфейс |
...
Главный вопрос: **чего не хватает, чтобы «Гермес Клин» стал центральным мозгом, а Telegram — удобным интерфейсом?**
...
| # | Блок | Статус | Риск | Кто | Следующий шаг |
|---|------|--------|------|-----|---------------|
| D1 | **Repo / remote / branch** | ❌ Отсутствует. Папки `github/` и `repos/` пусты | Нет бэкапа кода, нет истории изменений | User | Решить: нужен ли GitHub. Если да — создать repo, связать с «Гермес Клин» |
...
| # | Блок | Статус | Риск | Кто | Следующий шаг |
|---|------|--------|------|-----|---------------|
| E1 | **Что сохранять в long memory** | 🟡 Неясно. 10 папок созданы, но правила наполнения отсутствуют | Дублирование с «Гермес Клин» state, мусор | User + Hermes | `OBSIDIAN_LONG_MEMORY_RULES.md`: проекты, клиенты, знания, НЕ state/задачи |
...
| E3 | **Как не дублировать state** | 🔴 Критичное. Obsidian и «Гермес Клин» могут хранить одно и то же | Противоречия: Obsidian говорит одно, проект — другое | Hermes | Правило: **state только в «Гермес Клин»**. Obsidian — knowledge/notes, не state |
...
2. **E3 — Дублирование state между Obsidian и проектом** — два источника «правды». Риск: противоречия.
...
| Риск | Почему опасно | Кто может | Approval | Safe alternative | При сомнении |
|------|--------------|-----------|----------|------------------|-------------|
| **Obsidian vs проект state** | Два источника «правды» противоречат друг другу | Hermes | Правило: state → проект, knowledge → Obsidian | `OBSIDIAN_LONG_MEMORY_RULES.md` | **проект — главный.** |
...
| **Old status files vs new** | `MALYARKA_CURRENT_STATUS.md` vs `HERMES_STATE.md` | Hermes | Пометить старые как DEPRECATED | Только файлы проекта — источник правды | **проект — главный.** |
...
| Y6 | Обновление state-файлов | Без approval (Hermes) | Только `.md`, только проект |
...
| G2 | Создавать/редактировать `.md` файлы в проекте | Hermes |
...
| Что есть | Чего нет | Кто |
|----------|----------|-----|
| `HERMES_STATE.md` — главный state | Rules: что в Obsidian vs проект | Hermes |
| Obsidian long-memory (10 папок) | Авто-сохранение decisions в проекте | Hermes |
| Obsidian short-memory (6 папок) | Дедупликация проект ↔ Obsidian | Hermes |
...
| `05_Projects` | Описание проектов | «Гермес Клин», Malyarka Clean |
...
```
STATE → «Гермес Клин» (.md файлы: HERMES_STATE.md, sync/*, tasks/*)
KNOWLEDGE → Obsidian (заметки, правила, объяснения, шаблоны)
DECISIONS → проект (decisions/DECISIONS.md)
WORKLOG → проект (logs/WORKLOG.md)
```

**НИКОГДА не дублировать state в Obsidian.** проект — единственный источник правды.

#### Как избежать конфликтов

1. Если факт есть в проекте — НЕ записывать в Obsidian.
2. Если факт только в Obsidian — перенести в проекте при ревью.
3. Раз в неделю: `OBSIDIAN_SYNC_CHECK.md` — сверить проект и Obsidian.
4. Все решения → `decisions/DECISIONS.md` в проекте.
...
| P2 | E3: Правило «state → проект, knowledge → Obsidian» | Hermes | Риск: противоречия |
...
|------|----------------|------------|
| `HERMES_STATE.md` | После каждого батча / важного решения | Новый статус, новые файлы, изменения runtime |
...
**Еженедельно (Hermes):**
1. Сравнить `HERMES_STATE.md` с `SHARED_CURRENT_STATUS.md`.
2. Сравнить проект state с Obsidian (presence-only).
...
- Полная инвентаризация 2 проектов («Гермес Клин» + [архив] [удалённый архив])
- Архитектурная карта 3 систем (Telegram, проект, Desktop)
