...
# === HERMES ADAPTER HOOK ===    if _HERMES_ADAPTER_ENABLED:        try:            from malyarka_core.adapters.hermes_adapter import check_hermes_safety            hermes = check_hermes_safety(text)            if hermes.get("fallback_required"):                pass            elif hermes.get("blocked"):                return {                    "blocked": True,                    "block_reason": hermes.get("block_reason"),                    "confirmed_items": [],                    "disputed_items": [],                    "confirmed_count": 0,                    "disputed_count": 0,                    "total_quantity": 0,                    "total_area_m2": 0.0,                    "can_export": False,                    "export_blocked_reason": hermes.get("block_reason", "hermes_adapter_blocked"),                }        except Exception:            pass
