...
from malyarka_hermes.router import handle_user_text
from malyarka_hermes.safety import dangerous_response, is_dangerous_text
...
def build_text_response(
    ...
    if stripped == "" or stripped.startswith("!"):
        return TelegramTextResponse(handle_user_text(stripped))
    if is_dangerous_text(stripped):
        return TelegramTextResponse(dangerous_response())
