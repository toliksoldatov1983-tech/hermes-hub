...
Спроектировать tiny guarded call-site для будущего adapter boundary. Без кода.

## ОЖИДАЕМЫЙ РЕЗУЛЬТАТ

Создан plan-only документ tiny guarded call-site.
...
`REPORT_BUNDLE_301_330_TINY_GUARDED_CALLSITE_PLAN.md`
...
- `TINY_GUARDED_CALLSITE_PLAN_INCOMPLETE`
- `TINY_GUARDED_CALLSITE_PLAN_BLOCKED_MISSING_PREREQUISITES`
- `TINY_GUARDED_CALLSITE_PLAN_STOPPED_REVIEW_REQUIRED`
- `TINY_GUARDED_CALLSITE_PLAN_STOPPED_APPROVAL_REQUIRED`
- `TINY_GUARDED_CALLSITE_PLAN_STOPPED_SAFETY_RISK`
- `TINY_GUARDED_CALLSITE_PLAN_BLOCKED_NOT_READY`
