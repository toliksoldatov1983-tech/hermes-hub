...
Проверить readiness для будущего server patch. Не применять patch.

## ОЖИДАЕМЫЙ РЕЗУЛЬТАТ

Создан readiness gate report. При риске остановиться.
...
- `SERVER_PATCH_READINESS_GATE_COMPLETE`
- `SERVER_PATCH_READINESS_GATE_INCOMPLETE`
- `SERVER_PATCH_READINESS_GATE_BLOCKED_MISSING_PREREQUISITES`
- `SERVER_PATCH_READINESS_GATE_STOPPED_REVIEW_REQUIRED`
- `SERVER_PATCH_READINESS_GATE_STOPPED_APPROVAL_REQUIRED`
- `SERVER_PATCH_READINESS_GATE_STOPPED_SAFETY_RISK`
- `SERVER_PATCH_READINESS_GATE_BLOCKED_NOT_READY`
