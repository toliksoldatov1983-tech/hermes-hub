...
Финальный gate перед любыми server patch действиями. Не выполнять действия.

## ОЖИДАЕМЫЙ РЕЗУЛЬТАТ

Создан approval gate. Остановиться.
...
`BUNDLE_511_540_SERVER_PATCH_BUNDLE_PREP_ONLY`
...
`REPORT_BUNDLE_481_510_SERVER_PATCH_FINAL_APPROVAL_GATE.md`

## Status codes

Use one of:

- `SERVER_PATCH_FINAL_APPROVAL_GATE_COMPLETE`
- `SERVER_PATCH_FINAL_APPROVAL_GATE_INCOMPLETE`
- `SERVER_PATCH_FINAL_APPROVAL_GATE_BLOCKED_MISSING_PREREQUISITES`
- `SERVER_PATCH_FINAL_APPROVAL_GATE_STOPPED_REVIEW_REQUIRED`
- `SERVER_PATCH_FINAL_APPROVAL_GATE_STOPPED_APPROVAL_REQUIRED`
- `SERVER_PATCH_FINAL_APPROVAL_GATE_STOPPED_SAFETY_RISK`
- `SERVER_PATCH_FINAL_APPROVAL_GATE_BLOCKED_NOT_READY`
